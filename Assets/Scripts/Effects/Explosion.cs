...
public class Explosion : MonoBehaviour {
    ...
    {
        GameObject b1 = GameObject.Instantiate(bubble1);
        GameObject s1 = GameObject.Instantiate(smoke1);
        GameObject b2 = GameObject.Instantiate(bubble1);
        b2.transform.localScale = new Vector2(-b2.transform.localScale.x, b2.transform.localScale.y);
        GameObject s2 = GameObject.Instantiate(smoke1);
        GameObject s3 = GameObject.Instantiate(smoke1);
